...
train_data = datasets.MNIST('Project/data/mnist', train = True, transform = transform, download = False)
test_data = datasets.MNIST('Project/data/mnist', train = False, transform = transform, download = False)
...
torch.save(G.state_dict(), 'cGenerator.pt')
